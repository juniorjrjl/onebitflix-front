            ...
            <Form className={styles.form}>
                ...
                <div className={styles.inputNormalDiv}>
                    <FormGroup>
                        ...
                        <Input name='phone' type='tel' id='phone' placeholder='(xx) 9xxxx-xxxx' required maxLength={20} className={styles.input} value={'+55 (12) 98777-0908'}/>
                    </FormGroup>
                    <FormGroup>
                        <Label for='email' className={styles.label}>Whatsapp / Telegram</Label>
                        <Input name='email' type='email' id='email' placeholder='Informe seu email' required maxLength={20} className={styles.input} value={'teste@teste.com'}/>
                    </FormGroup>
